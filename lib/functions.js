...
exports.splitIoState = function(io_state){
  // console.log(io_state.substr(5, 3));
  return {
...
exports.parseCourseStatus = function(state){
  console.log(state.substr(5, 3));
  return {
    mcc: parseInt(io_state.substr(0, 1)),
    mnc: parseInt(io_state.substr(1, 1)),
    lac: exports.hex_to_int(io_state.substr(5, 3)),
    cell_id: exports.hex_to_int(io_state.substr(5, 3))
  };
};